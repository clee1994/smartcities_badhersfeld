...
def create_route(orig_xy, target_xy):
	...
	route = nx.shortest_path(graph,source=orig_node,target=target_node,weight='noise_cc_len')
	...
	return '../static/'+unique_filename+".png"
#plt.show()
...
def string_to_xy(name_bla):
	...
	req_string ='https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyBkwOnAuNBSBHzQ3751Kmjk0GDWFCRfbwE&address='+name_bla.replace(" ","+")
